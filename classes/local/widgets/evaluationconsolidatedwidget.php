...
/**
 * Consolidated evaluation widget showing all teachers.
 *
...
/**
 * Consolidated evaluation table widget rendering all teachers and their courses.
 */
class evaluationconsolidatedwidget extends widgets_info {
    ...
    /**
     * Constructor.
     * @param int $evalmonth Timestamp of first day of month, 0 for all.
     */
    public function __construct($evalmonth = 0) {
        parent::__construct();
    ...
    private function get_report_data() {
        ...
        $table = new \report_lmsace_reports\local\table\evaluationconsolidated_table(
            'evaluation-consolidated-table', $this->evalmonth
        );
