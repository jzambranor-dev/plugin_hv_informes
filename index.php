...
$teachercategory = optional_param('teachercategory', 0, PARAM_INT);
$coursecategory = optional_param('coursecategory', 0, PARAM_INT);
...
$output->teachercategory = $teachercategory;
$output->coursecategory = $coursecategory;
